...
import { Cpu, Radio, ShieldCheck, RefreshCw, Mic, Zap, Brain, Settings, RotateCcw, LogOut, MessageSquare } from 'lucide-react';
  ...
  return (
    <main className="min-h-screen bg-black text-white p-6 md:p-10">
      ...
      <div className="mt-6 grid grid-cols-1 gap-3">
        ...
        <a
          href="/chat"
          className="flex items-center gap-3 p-5 bg-zinc-900 border border-violet-900/50 hover:border-violet-700 rounded-2xl transition-all group"
        >
          <div className="p-2 bg-violet-900/30 rounded-xl">
            <MessageSquare size={20} className="text-violet-400" />
          </div>
          <div>
            <p className="text-sm font-semibold text-violet-300">Local Model Chat</p>
            <p className="text-xs text-zinc-500 mt-0.5">Chat with either Qwen model or either Gemma model on GPU1</p>
          </div>
